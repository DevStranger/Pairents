...
int gui_init(GUI *gui) {
    ...
    gui->font_text = TTF_OpenFont("Pairents/assets/MatrixtypeDisplayBold-6R4e6.ttf", 14);
    if (!gui->font_text) {
        fprintf(stderr, "TTF_OpenFont font_text failed: %s\n", TTF_GetError());
        return -1;
    }

    gui->font_ascii_art_default = TTF_OpenFont("Pairents/assets/MatrixtypeDisplayBold-6R4e6.ttf", 6);
    gui->font_ascii_art_small = TTF_OpenFont("Pairents/assets/MatrixtypeDisplayBold-6R4e6.ttf", 4);
